...
class _EcoStorePageState extends State<EcoStorePage> {
  ...
  Future<bool> _placeOrder({
    ...
    if (validEntries.isEmpty) {
      throw Exception('لا توجد منتجات صالحة في السلة');
    }
    ...
    batch.set(orderRef, {
      ...
      'giftName': includesGift ? 'الكبسولة الذكية الزراعية' : null,
    });
    ...
    await NotificationService.send(
      title: includesGift
          ? '🎁 تم تأكيد طلبك ومعه هدية!'
          : '🛍️ تم تأكيد طلبك!',
      body: includesGift
          ? 'شكراً $name! حصلت على هدية: الكبسولة الذكية الزراعية 🌱'
          : 'شكراً $name! طلبك قيد المعالجة وسيتم التواصل معك قريباً 🌿',
      type: 'store',
    );
  ...
  String? _getLocalAssetPath(String name) {
    final Map<String, String> mapping = {
      ...
      'طقم أدوات مائدة خشبي':
      'assets/images/products/wooden_tableware_set.png',
      ...
      'كفر جوال بلاستيك حيوي':
      'assets/images/products/bioplastic_phone_case.png',
      ...
      'حقيبة بلاستيك محيطات':
      'assets/images/products/ocean_plastic_bag.png',
      'سخان مياه حراري': 'assets/images/products/thermal_water_rain.png',
      'أحذية رياضية معاد تدويرها':
      'assets/images/products/recycled_sneakers.png',
            ...
            child: Column(
              children: [
                ...
                _field(
                  ...
                  nameCtrl,
                  v: (v) =>
                  (v?.trim().length ?? 0) < 3 ? 'أدخل اسمك الكامل' : null,
                ),
                const SizedBox(height: 12),
                _field(
                  'رقم الهاتف',
  ...
  void _showSuccess(String name, {bool gotGift = false}) => showDialog(
    context: context,
    builder: (_) => AlertDialog(
      ...
      content: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          Text(
            gotGift ? 'تم تأكيد طلبك ومعه هدية!' : 'تم تأكيد طلبك!',
            style: const TextStyle(
              fontFamily: 'Cairo',
              fontSize: 20,
              fontWeight: FontWeight.w900,
          ...
          Text(
            gotGift
                ? 'شكراً $name!\nحصلت على هدية: الكبسولة الذكية الزراعية 🌱'
            ...
            return Scaffold(
              ...
              body: CustomScrollView(
                slivers: [
                  ...
                  // ✅ الهيدر
                  SliverToBoxAdapter(
                    child: _buildHeader(allProducts, pts, _validCartCount(allProducts)),
                  ),
                  ...
                  filtered.isEmpty
                    ...
                    sliver: SliverGrid(
                      delegate: SliverChildBuilderDelegate(
                            (_, i) => _productCard(filtered[i], pts, d, allProducts),
  ...
  Widget _discountBanner(int pts, double d) => Container(
    ...
    child: Row(
      children: [
        ...
        const SizedBox(width: 10),
        Text(
          'خصمك ${(d * 100).toInt()}% فعال! | نقاطك: $pts',
          style: const TextStyle(
            fontFamily: 'Cairo',
            fontSize: 13,
            fontWeight: FontWeight.w700,
